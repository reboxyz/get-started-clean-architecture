...
public class Gym
{
    ...
    {
        _roomIds.Throw().IfNotContains(roomId);
    ...
    public ErrorOr<Success> AddTrainer(Guid trainerId)
    {
        ...
        {
            return Error.Conflict(description: "Trainer already added in the gym");
        }
    ...
    {
        _trainerIds.Throw().IfNotContains(trainerId);
        _trainerIds.Remove(trainerId);
    }
